...
// ______________________FUNCTIONS MINIATURES______________________________

function imagethumb( $image_src , $image_dest = NULL , $max_size=200, $expand = FALSE, $square = TRUE )
{
